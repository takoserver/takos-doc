        ...
        <section class="relative w-full h-[80vh] flex items-center justify-center bg-gray-900">
          ...
          <div class="relative z-10 max-w-4xl px-4 md:px-6 text-center space-y-6">
            ...
            <div class="flex justify-center gap-4">
              <a
                href="#"
                class="inline-flex h-10 items-center justify-center rounded-md bg-[#4db56a] px-8 text-sm font-medium text-white shadow transition-colors hover:bg-[#00a185] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#00b894] disabled:pointer-events-none disabled:opacity-50"
              >
                Get Started
              </a>
              <a
